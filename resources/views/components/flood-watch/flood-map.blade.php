...
@if ($mapCenter)
<div id="map-section" wire:key="map-{{ $lastChecked ?? 'initial' }}-{{ $routeGeometry ? md5(json_encode($routeGeometry)) : 'no-route' }}" class="rounded-lg overflow-hidden border border-slate-200">
    <div
        class="flex flex-col"
