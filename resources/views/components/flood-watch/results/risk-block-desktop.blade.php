...
<div id="your-risk">
    ...
    <div class="p-4 rounded-lg bg-white shadow-sm border border-slate-200 space-y-1.5 text-sm">
    ...
    @if ($hasDangerToLife)
        <div class="mt-3 p-3 rounded-lg bg-red-50 border-2 border-red-500">
