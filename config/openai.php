...
return [
    ...
    */
    ...
    | for a response. Local dev defaults to 10s for faster feedback; production
    | uses 30s. Override with OPENAI_REQUEST_TIMEOUT.
    |
    */

    'request_timeout' => env('OPENAI_REQUEST_TIMEOUT', env('APP_ENV') === 'local' ? 10 : 30),
];
